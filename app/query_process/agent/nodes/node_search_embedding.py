...
def node_search_embedding(state):
    ...
    embedding_chunks = res[0] if res else []
...
if __name__ == "__main__":
    # 模拟测试数据
    test_state = {
        "session_id": "test_search_embedding_002",
        "rewritten_query": "H3C LA2608 室内无线网关",  # 模拟改写后的查询
        "item_names": ["H3C LA2608 室内无线网关"],  # 模拟已确认的商品名
        "is_stream": False
    }
